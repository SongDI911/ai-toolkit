...
class QwenImageEditModel(BaseModel):
    ...
    def load_model(self):
        ...
        self.noise_scheduler = QwenImageEditModel.get_train_scheduler()

        self.print_and_status_update("Making pipe")

        pipe: QwenImageEditPipeline = QwenImageEditPipeline(
    ...
    def get_noise_prediction(
        ...
        latent_model_input = latent_model_input.reshape(batch_size, (height // 2) * (width // 2),
